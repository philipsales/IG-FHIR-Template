---
title: AWH Implementation Guide HomePage
layout: default
active: home
---
...
We improve access to healthcare services

Our international network of partners share resources, healthcare services and products which we help local communities access in low- and middle-income countries.

We empower locally trusted partners (ranging from individuals to organisations) to provide access to basic healthcare services through two key technology platforms that connect them to a broad range of available services. By improving existing, locally-embedded community facilities we enable basic services to stretch further into communities - giving essential support where traditional healthcare facilities don't reach, and helping existing clinics support more patients.

{% include img.html img="logo_curis.jpg" caption="Figure 1: Services" %}
